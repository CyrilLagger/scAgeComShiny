...
get_TCA_keyword_summary <- function(
  ...
  renderPlot({
    req(input$TCA_KEYWORD_CATEGORY_CHOICE, input$TCA_KEYWORD_VALUE_CHOICE)
    get_plot_keyword_tissue_vs_dataset(input$TCA_KEYWORD_VALUE_CHOICE)
  })
}
